<template>
  <div class="maintenancePlanAdd">
    ...
    <img id="expImg" src="./assets/icons/exp.jpg" />
  </div>
</template>
<script>
export default {
...
.draw-btn-group {
  ...
  & > div {
    ...
    .icon-pentagram {
      background-image: url("./assets/icons/pentagram.png");
    }
    .icon-2 {
    ...
    .icon-4 {
      background-image: url("./assets/icons/4.png");
      background-size: 75%;
    }
    .icon-5 {
    ...
    .icon-mouse {
      background-image: url("./assets/icons/mouse.png");
      background-size: 60%;
    }
  }
  .active {
